...
import tallerpolimorfismo.Modelo.*;
...
public class ClienteMain {
    ...
    public static void leerViajes() {
        try {
            ...
            Viaje viaje1 = new ViajeFamiliar(5,"Popayán", "Bogotá", 1250000, new SimpleDateFormat("dd/MM/yyyy").parse("01/05/2019"), 
                    new SimpleDateFormat("dd/MM/yyyy").parse("05/05/2019"));
            viajes.add(viaje1);

            Viaje viaje2 = new ViajeIncentivo("Emtel","Popayán", "Medellin", 2100000, new SimpleDateFormat("dd/MM/yyyy").parse("03/06/2019"),
